...
def start_timer():
    global reps
    reps += 1
    work_sec = (WORK_MIN*60)  # reps 1,3,5,7
    break_sec = (SHORT_BREAK_MIN*60)  # reps 2,4,6
    long_break_sec = (LONG_BREAK_MIN*60)  # 8

    if reps == 8:
        count_down(long_break_sec)
        title_label.config(text="Break", fg=RED, font=(FONT_NAME, 40, "bold"))
    elif reps % 2 == 0:
        title_label.config(text="Break", fg=PINK, font=(FONT_NAME, 40, "bold"))
